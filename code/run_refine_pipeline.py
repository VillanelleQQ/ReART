...
from common import build_id_map, dump_json, ensure_dir, load_json
from decomposer import build_requirement_packet
from reference_router import build_annotation_map, build_retrieval_map, route_references
from verifier import build_refine_plan
...
def main() -> None:
    ...
    from materialize_refine_packet import build_refine_prompt, select_reference_records
